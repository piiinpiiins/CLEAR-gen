...
const CONTENT_FARM_PATTERNS = [
    ...
    /难怪/, /怪不得/, /细思极恐/, /太疯狂了/,
    /[变變][现現]/, /[财財]富自由/, /搞[钱錢]/, /睡后收入/, /睡後收入/, /被[动動]收入/,
    // 台灣內容農場常見用詞
    /[驚嚇傻]呆了/, /嚇壞了/, /傻眼了/, /崩[潰溃]了/,
    /太扯了/, /太[誇夸][張张]了/, /太離譜了/,
    /網友[暴爆]動/, /[笑哭嗨]翻/, /炸鍋/,
    /真的假的/, /你敢信/, /居然/, /萬萬沒想到/,
    /[一秒看完].{0,3}[秒看]懂/, /不看.*後悔/, /錯過.*沒了/,
    /[最獨][新家].{0,3}[公曝][開光]/, /終於[曝公][光開]/,
    /90%.{0,3}人.*不知道/, /很多人.*做錯/, /一直.*搞錯/,
    /看完.*[淚鼻]/, /催淚/, /[超好]暖[心到]/, /暖到爆/,
    /網友[怒氣]了/, /[引爆].*怒火/, /氣炸了/,
    /神回[覆復]/, /神留言/, /留言區.*[炸爆]/,
    /[灑狗]血/, /一次看/,
];
